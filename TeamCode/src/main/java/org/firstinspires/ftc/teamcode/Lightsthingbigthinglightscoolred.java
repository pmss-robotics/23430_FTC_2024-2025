...
*/
        ...
        // Noah's RGB light stuff
        RGBCycle colors = new RGBCycle(hardwareMap, telemetry);
        waitForStart();

        // Continuously cycle the colors while the OpMode is active
        while (opModeIsActive()) {
            colors.cycleColors(20); // Cycle with a 20ms delay
        }
    }
}
