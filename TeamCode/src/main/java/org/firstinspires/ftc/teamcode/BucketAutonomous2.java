...
//                .strafeToLinearHeading(new Vector2d(-35, 60), 0)
        ...
        Action trajectory1 = drive.actionBuilder(drive.getPose())
                .splineToLinearHeading(new Pose2d(-55, -55, Math.toRadians(25)), -Math.PI/2)
                .build();
        ...
        Action trajectory2 = drive.actionBuilder(new Pose2d(-55, -55, Math.toRadians(35)))
                .splineToLinearHeading(new Pose2d(-52, -52, Math.toRadians(85)), Math.PI)
                .build();
        Command traj2 = new ActionCommand(trajectory2, Stream.of(drive).collect(Collectors.toSet()));

        Action trajectory3 = drive.actionBuilder(new Pose2d(-52, -52, Math.toRadians(85)))
                .splineToLinearHeading(new Pose2d(-55, -55, Math.toRadians(45)), Math.PI)
                .build();
        ...
        Action trajectory5 = drive.actionBuilder(new Pose2d(-52, -52, Math.toRadians(105)))
                .splineToLinearHeading(new Pose2d(-54, -54, Math.toRadians(45)), Math.PI)
                .build();
        ...
        Action trajectory7 = drive.actionBuilder(new Pose2d(-53, -51, Math.toRadians(110)))
                .splineToLinearHeading(new Pose2d(-54, -54, Math.toRadians(45)), Math.PI)
                .build();
...
*/
        ...
        Command auto = new SequentialCommandGroup(
                ...
                new WaitCommand(intakeWaitMili),
