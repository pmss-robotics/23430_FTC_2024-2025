...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(10, -61.5, Math.PI/2))
                ...
                .splineToConstantHeading(new Vector2d(35, -35), Math.PI/2)
                ...
                .waitSeconds(0.1)
                .strafeToSplineHeading(new Vector2d(12, -35), Math.PI*1.5)
                .waitSeconds(0.5)
                .strafeToSplineHeading(new Vector2d(37, -55), Math.PI*.5)
                .strafeTo(new Vector2d(37, -59))
                .waitSeconds(0.1)
                .strafeToSplineHeading(new Vector2d(8, -35), Math.PI*1.5)
                .waitSeconds(0.5)
                .strafeToSplineHeading(new Vector2d(37, -55), Math.PI*.5)
                .strafeTo(new Vector2d(37, -59))
                .strafeToSplineHeading(new Vector2d(6, -35), Math.PI*1.5)
                .waitSeconds(0.5)
